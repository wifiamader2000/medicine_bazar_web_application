...
const Home = () => {
  ...
  useEffect(() => {
    const fetchHomeData = async () => {
      try {
        ...
        // Show max 20 products in the featured section
  ...
  return (
    <div className="space-y-16 pb-24 text-slate-800">
      ...
      {/* 1. HERO SECTION (Bangla Header & Subtitle with visual card) */}
      <section className="relative rounded-3xl overflow-hidden hero-gradient p-8 md:p-14 text-white shadow-xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <h1 className="text-3xl md:text-5xl font-black tracking-tight leading-tight">
              ঘরে বসেই বিশ্বস্ত <br className="hidden md:inline" />
              <span className="text-[var(--color-teal)]">ফার্মেসি সেবা</span>
            </h1>
            
            <p className="text-sm md:text-base text-slate-200 font-medium max-w-xl">
              Order medicines, upload prescriptions, and manage healthcare products from Medicine Bazar. Fast delivery and real pharmacist support at your command.
            </p>
            ...
            <form onSubmit={handleSearch} className="bg-white p-1.5 rounded-2xl flex shadow-lg max-w-lg ring-4 ring-white/10">
              <input 
                type="text" 
                placeholder="ওষুধ, জেনেরিক, কোম্পানি বা রোগের নাম লিখুন..." 
            ...
            <div className="flex flex-wrap gap-3 pt-2">
              <Button onClick={() => navigate('/shop')} variant="secondary" size="sm" className="font-bold text-white border-white hover:bg-white/10">
                {language === 'en' ? 'Shop Medicines' : 'ওষুধ কিনুন'}
              </Button>
              <Button onClick={() => navigate('/checkout')} variant="primary" size="sm" className="font-bold text-white bg-slate-900 border-slate-900 hover:bg-slate-800">
                {language === 'en' ? 'Upload Prescription' : 'প্রেসক্রিপশন আপলোড'}
              </Button>
              <a href="https://wa.me/8801602444532" target="_blank" rel="noreferrer" className="inline-flex items-center justify-center font-bold px-4 py-1.5 rounded-[12px] bg-[#25D366] text-white hover:bg-[#20ba56] text-sm shadow-sm transition-all">
          ...
          <div className="lg:col-span-5 flex justify-center">
            <div className="glass-panel text-slate-800 rounded-3xl p-6 w-full max-w-sm border border-white/20 shadow-2xl relative overflow-hidden bg-white/95">
      ...
      <section className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="trust-card p-5 text-center flex flex-col items-center">
      ...
      <section className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Bento Card 1: Prescription Upload */}
          <div className="glass-card p-6 border-l-4 border-l-[var(--color-primary)] flex flex-col justify-between h-56">
            ...
            <div className="pt-4">
              <Button onClick={() => navigate('/checkout')} variant="primary" size="sm" className="font-bold flex items-center gap-1">
          ...
          <div className="glass-card p-6 border-l-4 border-l-[#25D366] flex flex-col justify-between h-56">
            <div className="space-y-2">
              <span className="text-3xl">💬</span>
            ...
            <div className="pt-4 flex gap-2">
              <a href="https://wa.me/8801602444532" target="_blank" rel="noreferrer" className="inline-flex items-center justify-center font-bold px-4 py-1.5 rounded-[12px] bg-[#25D366] text-white hover:bg-[#1fbc53] text-sm shadow-sm transition-all min-h-[38px]">
                <MessageCircle size={14} className="mr-1.5" />
                <span>WhatsApp</span>
              </a>
              <a href="tel:01602444532" className="inline-flex items-center justify-center font-bold px-4 py-1.5 rounded-[12px] bg-slate-800 text-white hover:bg-slate-700 text-sm shadow-sm transition-all min-h-[38px]">
          ...
          <div className="glass-card p-6 border-l-4 border-l-[var(--color-trust)] flex flex-col justify-between h-56">
            <div className="space-y-2">
              <span className="text-3xl">🏪</span>
            ...
            <div className="pt-4">
              <Button onClick={() => navigate('/shop')} variant="secondary" size="sm" className="font-bold flex items-center gap-1 border-[var(--color-trust)] text-[var(--color-trust)] hover:bg-[var(--color-trust)]/5">
